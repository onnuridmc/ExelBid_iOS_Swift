...
struct EBAdInfo {
    ...
    func bannerAds() -> [EBAdInfoModel] {
        return [EBAdInfoModel(title: "배너광고", ID: "cd54f7365c637fc41327422e3b7dee8d7fb3dcec", type: .Banner),
                EBAdInfoModel(title: "전면광고", ID: "e88b95b25a0c736cb218135814f84f644dfd4248", type: .AllBanner),
                EBAdInfoModel(title: "다이얼로그광고", ID: "cd54f7365c637fc41327422e3b7dee8d7fb3dcec,e88b95b25a0c736cb218135814f84f644dfd4248", type: .DailBanner)]
    }
    
    func nativeAds() -> [EBAdInfoModel] {
        return [EBAdInfoModel(title: "네이티브", ID: "7590634941fa4bd366b49bb46eb3043bc63d42d6", type: .Native),
                EBAdInfoModel(title: "네이티브 Banner", ID: "7590634941fa4bd366b49bb46eb3043bc63d42d6", type: .NativeBanner),
    ...
    func videoAds() -> [EBAdInfoModel] {
        return [EBAdInfoModel(title: "비디오 전면", ID: "202748c414a9f9a0be6c73893bc1589c6bc9af4a", type: .Video),
    ...
    func etcAds() -> [EBAdInfoModel] {
        ...
        return [
                ...
                EBAdInfoModel(title: "애드태그", ID: "cd54f7365c637fc41327422e3b7dee8d7fb3dcec", type: .AdTag)]
    }
