...
class EBNativeDialogView: UIView {
    var adView: UIView!
    ...
    override init(frame: CGRect) {
        ...
        let adBackView = UIView(frame: CGRect(x: 20, y: (frame.size.height - 360)/2, width: frame.size.width - 40, height: 360))
        adBackView.backgroundColor = UIColor.white
        self.addSubview(adBackView)
        adBackView.setAutoLayout(self, top: nil, left: 20, right: -20, bottom: nil, height: 360, width: nil)
...
//        lineView.setAutoLayout(adBackView, top: 50, left: 0, right: 0, bottom: nil, height: 1, width: nil)
        ...
        adView = UIView(frame: CGRect(x: 0, y: 0, width: adBackView.frame.size.width, height: adBackView.frame.size.height - 70))
        adBackView.addSubview(adView)
        adView.setAutoLayout(adBackView, top: 0, left: 0, right: 0, bottom: -80, height: nil, width: nil)

        closeButton = UIButton(frame: CGRect(x: 10, y: adBackView.frame.size.height - 55, width: adBackView.frame.size.width/2 - 20, height: 50))
        ...
        closeButton.setAutoLayout(adBackView, top: nil, left: 10, right: nil, bottom: -5, height: 50, width: Int(adBackView.frame.size.width/2 - 20))

        cancleButton = UIButton(frame: CGRect(x: adBackView.frame.size.width/2 + 10, y: adBackView.frame.size.height - 55, width: adBackView.frame.size.width/2 - 20, height: 50))
        ...
        cancleButton.setAutoLayout(adBackView, top: nil, left: nil, right: -10, bottom: -5, height: 50, width: Int(adBackView.frame.size.width/2 - 20))
    }
