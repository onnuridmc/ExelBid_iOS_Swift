 ...
 */
@interface OMIDCjnetAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDCjnetPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDCjnetPartner *)partner
                               ...
                               resources:(NSArray<OMIDCjnetVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
