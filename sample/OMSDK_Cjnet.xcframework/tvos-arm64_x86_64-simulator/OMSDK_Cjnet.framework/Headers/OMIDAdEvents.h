 ...
 */
@interface OMIDCjnetAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDCjnetAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDCjnetVASTProperties *_Nonnull)vastProperties
