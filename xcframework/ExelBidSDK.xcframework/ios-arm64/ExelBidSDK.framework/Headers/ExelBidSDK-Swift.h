...
- (UIView * _Nullable)retrieveAdViewWithAdView:(id <EBNativeAdRendering> _Nonnull)adView SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull kAdLogoKey;)
+ (NSString * _Nonnull)kAdLogoKey SWIFT_WARN_UNUSED_RESULT;
