 ...
 */
@interface OMIDCjnetAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDCjnetAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDCjnetAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDCjnetAdSessionContext *)context
