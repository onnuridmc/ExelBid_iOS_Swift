...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.mainVideoView = [[UIView alloc] init];
        self.mainVideoView.contentMode = UIViewContentModeScaleAspectFill;
        self.mainVideoView.clipsToBounds = YES;
...
- (void)layoutSubviews
{
    ...
    self.mainVideoView.frame = CGRectMake(width / 2 - 150, 119, 300, 156);
