...
@interface EBMPartnersNativeAdViewController ()<UITextFieldDelegate, EBNativeAdDelegate>
...
@implementation EBMPartnersNativeAdViewController
...
- (IBAction)loadAdClicked:(id)sender
{
    ...
    MPartnersNativeManager * ebNativeManager = [[MPartnersNativeManager alloc] init:self.keywordsTextField.text :[EBNativeAdView class]];
