//
//  EBNativeVideoAdViewController.m
//
...
@interface EBNativeVideoAdViewController ()<UITextFieldDelegate, EBNativeAdDelegate>
...
@implementation EBNativeVideoAdViewController
...
- (IBAction)loadAdClicked:(id)sender
{
    ...
    ExelBidNativeManager * ebNativeManager = [[ExelBidNativeManager alloc] init:self.keywordsTextField.text :[EBNativeAdView class]];
